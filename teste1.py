...
def montar_sessao(palestras, min_tempo, max_tempo):
    ...
    def backtrack(indice, sessao_atual, tempo_atual):
        ...
        if tempo_atual >= min_tempo and tempo_atual > melhor_tempo:
            ...
            melhor_sessao = sessao_atual[:]

            if melhor_tempo == max_tempo:
                return
    ...
    # Esse loop é causado porque não esta marcando as palestras como usadas, ou seja a execução da track B fica infinita!
