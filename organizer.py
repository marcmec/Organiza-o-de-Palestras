...
class ConferenceOrganizer:
    """
    Classe responsável por organizar palestras em tracks de conferência.
    
    Implementa algoritmo guloso que:
    1. Ordena palestras por duração (decrescente)
    2. Aloca palestras nas sessões respeitando limites de tempo
    3. Garante que networking seja entre 16h-17h
    """
